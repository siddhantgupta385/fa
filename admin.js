...
class AdminPanel {
    ...
    async loadSkills() {
        try {
            const skills = await SupabaseDB.getSkills();
            ...
            skills.forEach(skill => {
                ...
                skillCard.innerHTML = `
                    ...
                    <div class="item-actions">
                        <button class="edit-btn" onclick="admin.editSkill(${skill.id})">Edit</button>
                        <button class="delete-btn" onclick="admin.deleteSkill(${skill.id})">Delete</button>
                    </div>
                `;
    ...
    async openSkillModal(skill = null) {
        ...
        if (skill) {
            ...
            this.currentEditSkillId = skill.id;
        } else {
    ...
    async saveSkill() {
        try {
            ...
            if (this.currentEditSkillId) {
                await SupabaseDB.updateSkill(this.currentEditSkillId, skillData);
                this.showSuccess('Skill updated successfully');
            } else {
                await SupabaseDB.createSkill(skillData);
            ...
            this.showError('Failed to save skill: ' + error.message);
        }
    }
    ...
    async deleteSkill(id) {
        if (confirm('Are you sure you want to delete this skill?')) {
            try {
                ...
                this.showError('Failed to delete skill: ' + error.message);
            }
        }
    }
